                    ...
                    <form onSubmit={handleSwap} className="space-y-4">
                            ...
                            <div className="flex space-x-4">
                                ...
                                <label className="flex items-center space-x-2 cursor-pointer">
                                    <input
                                        ...
                                        className="form-radio text-brand-primary"
                                    />
                                    <span className="text-white">Tam Montaj Grubu</span>
                                </label>
                            </div>
                        </div>
                        ...
                        {swapState.swapType === 'Assembly' && (
                            <select
                                ...
                                required
                            >
                                <option value="">-- Montaj Grubu Seçin --</option>
                        ...
                        <select
                            ...
                            required
                        >
                            <option value="">2. ÇIKARILACAK {swapState.swapType === 'Assembly' ? 'Montaj Grubu' : 'Parça'} Seçin</option>
                            {inventory?.map(i => (
                        ...
                        <select
                            ...
                            required
                        >
                            <option value="">3. TAKILACAK {swapState.swapType === 'Assembly' ? 'Montaj Grubu' : 'Parça'} Seçin (Depodan)</option>
                            {inventory?.map(i => (
                                <option key={i.id} value={i.id}>
                                    {`${i.description} (SN: ${i.serialNumber})`}
                                </option>
                        ...
                        <button type="submit" className="bg-brand-primary hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-md">
                            {swapState.swapType === 'Assembly' ? 'Montaj Grubu' : 'Parça'} Değişimini Gerçekleştir
                        </button>
                    </form>
                </div>
            )}
