        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                <div className="lg:col-span-3 grid grid-cols-4 gap-6">
                    ...
                    <div className={`bg-brand-card p-4 rounded-lg border ${
                        lifeLimitWarnings.length > 0 
                            ? 'border-yellow-500/50 bg-yellow-500/10' 
                            : 'border-brand-border'
                    } text-center`}>
                        <p className="text-sm text-brand-light">PARÇA ÖMÜR UYARISI</p>
                        <p className={`text-4xl font-bold ${
                            lifeLimitWarnings.length > 0 ? 'text-yellow-400' : 'text-green-400'
                        }`}>
            ...
            {/* Life Limit Warnings - Only show if there are warnings */}
            {lifeLimitWarnings.length > 0 && (
                <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-lg p-4">
                    ...
                    <div className="space-y-2">
                        {lifeLimitWarnings.map((warning, idx) => (
                            <div key={idx} className="bg-brand-dark p-3 rounded-md flex justify-between items-center">
                                <div>
                                    <p className="font-semibold text-white">{warning.component.description}</p>
                                    <p className="text-sm text-brand-light">
                                        SN: {warning.component.serialNumber} • PN: {warning.component.partNumber}
                                    </p>
                                </div>
                                <div className="text-right">
                                    ...
                                    <p className="text-sm text-brand-light">
                                        {warning.hoursRemaining} saat kaldı
                                    </p>
                                </div>
                            </div>
                        ))}
